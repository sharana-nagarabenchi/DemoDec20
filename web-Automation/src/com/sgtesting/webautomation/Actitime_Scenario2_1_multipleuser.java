...
public class Actitime_Scenario2_1_multipleuser{
...
//			Thread.sleep(4000);
	...
	static String s1;
	String username_isempty()
	{
		WebElement s = oBrowser.findElement(By.xpath("//*[@id=\"userListTableContainer\"]/table/tbody/tr[2]/td[1]/table/tbody/tr/td/div[1]/span[2]"));
		s1 = new String();
		s1= s.getText();
		return s1;
	}
...
//				String s = oBrowser.findElement(By.name("firstName")).sendKeys("demo");
